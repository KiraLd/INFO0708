...
alter table formateur 
  add foreign key fk_formateur_virtuel (id_personne)
      references virtuel (id_personne) ;
...
alter table virtuel 
  add foreign key fk_virtuel_personne (id_personne)
      references personne (id_personne) ;
...
alter table gestionnaire 
  add foreign key fk_gestionnaire_virtuel (id_personne)
      references virtuel (id_personne) ;
