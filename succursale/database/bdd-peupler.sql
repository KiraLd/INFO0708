...
insert into `sous_theme` (`id_sous_theme`, `id_theme`, `libelle`, `code`, `description`) values (0,0,'Développement Web','DEV-WEB','Introduction aux principes de développement d''application web. Utilisation des languages HTML,PHP,CSS,JAVASCRIPT.');
insert into `sous_theme` (`id_sous_theme`, `id_theme`, `libelle`, `code`, `description`) values (1,0,'Développement Java','DEV-JAVA','Introduction aux principes de développement clients/serveur en Java. Utilisation des technologies RMI et J2E.');
...
insert into `client` (`id_client`, `nom`, `adresse`, `telephone`, `mail`) values (0, 'client-entreprise', '8 rue du chêne Reims', '0123456789', 'client@entreprise.com');
