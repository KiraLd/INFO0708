...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_1078337" class="appnitro"  method="post" action="supprimeClient.php">
					<div class="form_description">
			<h2>Supprimer salle</h2>
			<p>Veuillez identifier le client a supprimer ci-dessous.</p>
		</div>						
			<ul >
			<div class="right">
			<li id="li_4" >
		<label class="description" for="element_6">ID client </label>
			<select class="element select medium" id="id_client" name="id_client"> 
